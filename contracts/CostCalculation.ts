...
export const GROK_PRICING = {
  ...
  textOutputTokens: 0.000010,  // $0.010 per 1K tokens
  
  // Image generation (grok-2-image-alpha)
  imageGeneration: 0.10,  // $0.10 per image
...
export const COST_THRESHOLDS = {
  warning: 5.00,   // Warn user if cost exceeds $5
  high: 10.00,     // Show high cost warning if exceeds $10
  maximum: 20.00,  // Maximum allowed cost
} as const
...
export const COST_CALCULATION_ERROR_MESSAGES: Record<CostCalculationErrorCode, string> = {
  [CostCalculationErrorCode.INVALID_USAGE_DATA]: 
    'Invalid API usage data provided',
  [CostCalculationErrorCode.MISSING_PROMPT_USAGE]: 
    'Missing prompt generation usage data',
  [CostCalculationErrorCode.MISSING_IMAGE_USAGE]: 
    'Missing image generation usage data',
  [CostCalculationErrorCode.INVALID_IMAGE_COUNT]: 
    'Invalid image count for estimation',
  
  [CostCalculationErrorCode.NEGATIVE_COST]: 
    'Calculated cost is negative - data may be invalid',
  [CostCalculationErrorCode.COST_OVERFLOW]: 
    'Cost calculation resulted in overflow',
  [CostCalculationErrorCode.CALCULATION_FAILED]: 
    'Failed to calculate cost',
  
  [CostCalculationErrorCode.COST_EXCEEDS_MAXIMUM]: 
    'Estimated cost exceeds maximum allowed ($20.00)',
  [CostCalculationErrorCode.INSUFFICIENT_BUDGET]: 
    'Insufficient budget for this operation',
}
