...
export const PROMPT_GENERATION_ERROR_MESSAGES: Record<PromptGenerationErrorCode, string> = {
  ...
  [PromptGenerationErrorCode.API_KEY_INVALID]: 'Grok API key is invalid - please contact support',
  [PromptGenerationErrorCode.API_TIMEOUT]: 'Request timed out - please try again',
  [PromptGenerationErrorCode.API_RATE_LIMIT]:
    'Too many requests - please wait a moment and try again',
  [PromptGenerationErrorCode.API_ERROR]: 'Grok API error - please try again',

  [PromptGenerationErrorCode.NO_REFERENCE_IMAGES]: 'No reference images provided',
  [PromptGenerationErrorCode.INVALID_REFERENCE_URL]:
    'Reference image URL is invalid or unreachable',
  [PromptGenerationErrorCode.INVALID_STYLE_INPUTS]: 'Style inputs are invalid',
  [PromptGenerationErrorCode.INVALID_MODEL]: 'Invalid Grok model specified',
  ...
  [PromptGenerationErrorCode.PROMPT_TOO_SHORT]: 'Generated prompt is too short',
  [PromptGenerationErrorCode.PROMPT_TOO_LONG]: 'Generated prompt exceeds maximum length',
  [PromptGenerationErrorCode.DUPLICATE_CARD_NUMBER]: 'Duplicate card number in response',
  [PromptGenerationErrorCode.MISSING_CARD_NUMBER]: 'Missing card number in response',

  [PromptGenerationErrorCode.NETWORK_ERROR]: 'Network error - please check your connection',
  [PromptGenerationErrorCode.IMAGE_URL_UNREACHABLE]: 'Reference image cannot be accessed',

  [PromptGenerationErrorCode.INSUFFICIENT_CREDITS]:
    'Insufficient API credits - please contact support',
  [PromptGenerationErrorCode.QUOTA_EXCEEDED]: 'API quota exceeded - please try again later',
}
