...
export interface IStateStore {
   ...
   */
  acquireFileLock(filePath: string, agent: 'claude' | 'copilot' | 'user', ttlMs?: number): Promise<boolean>
   ...
   * Set context value
   */
  setContext(key: string, value: unknown, agent: 'claude' | 'copilot' | 'user', persistent?: boolean): Promise<void>
