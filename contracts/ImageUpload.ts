...
export const IMAGE_UPLOAD_ERROR_MESSAGES: Record<ImageUploadErrorCode, string> = {
  [ImageUploadErrorCode.INVALID_FILE_TYPE]: 
    'Please upload only JPEG or PNG images',
  [ImageUploadErrorCode.FILE_TOO_LARGE]: 
    'Image must be smaller than 10MB',
  [ImageUploadErrorCode.FILE_CORRUPTED]: 
    'Unable to read image file - it may be corrupted',
  [ImageUploadErrorCode.TOO_MANY_FILES]: 
    'You can only upload up to 5 images',
  [ImageUploadErrorCode.TOO_FEW_FILES]: 
  ...
  [ImageUploadErrorCode.IMAGE_NOT_FOUND]: 
    'Image not found - it may have been removed',
  [ImageUploadErrorCode.DUPLICATE_IMAGE]: 
