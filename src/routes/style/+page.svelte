...
<svelte:head>
  ...
  <meta name="description" content="Define the visual style for your custom tarot deck" />
</svelte:head>
...
<div class="page-container">
  ...
  {#if appStore.styleInputs}
    <div class="navigation-actions">
      <a href="/upload" class="nav-button secondary"> ← Back to Upload </a>
      <button class="nav-button primary" onclick={handleContinue}> Continue to Prompts → </button>
    </div>
  {/if}
</div>
